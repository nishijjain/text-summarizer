...
class SummaryTool{
	...
	/* instantiates and initializes all variables required. */
	void init(){
	...
	/* Primitive sentence tokenizer which gets the sentences from the entire passage based on period (fullstops) */
